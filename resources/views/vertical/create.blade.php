    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box" >
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" id="form" method="post" action="{{ url('save_vertical') }}" autocomplete="on" enctype="multipart/form-data">
                    {{ csrf_field() }}
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <textarea class="form-control" name="vertical_name" id="vertical_name" rows="3" placeholder="Enter ..."></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="box-footer">
                    <a class="btn btn-default" href="{{ url('vertical') }}"> Cancel</a>
