    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box" >
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" id="form" method="post" action="{{ url('save_service') }}" autocomplete="on" enctype="multipart/form-data">
                    {{ csrf_field() }}
                  <div class="box-body">
                      <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">Vertical Name</label>

                      <div class="col-sm-10">
                          <select class="form-control select2" id="vertical_id" name="vertical_id" required >
                            <option value="">-- Select Vertical --</option>
                            @foreach($vertical as $vert)
                            <option value="{{$vert->id}}" selected>{{$vert->vertical_name}}</option>
                            @endforeach
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <input type="text" name="service_name" id="service_name" class="form-control" rows="3" placeholder="Service Name">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <select class="form-control select2" style="width: 100%;" id="type_of_service" name="type_of_service" >
